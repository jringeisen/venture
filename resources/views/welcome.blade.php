...
<body class="antialiased">
    <nav id="nav" class="sticky top-0 bg-primary-dark-gray z-50 py-5 px-3">
        <div class="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <ul class="hidden space-x-6 text-white text-base tracking-wider md:flex">
            ...
            <div class="cursor-pointer block md:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="w-20 text-primary-yellow">
    ...
    <div class="relative">
            ...
            <section id="hero" class="mt-10 lg:mt-32">
                <div class="flex justify-center">
                    <div class="px-10 w-full space-y-8 lg:px-0 md:w-2/3 xl:w-5/12">
                        <h1 class="text-4xl text-white text-center font-thin lg:text-5xl">Curiosity-led learning for creative minds,
        ...
        <section class="h-[700px] lg:h-[600px]">
            <div id="grades" class="relative h-full bg-cover bg-center bg-fixed">
                ...
                <div class="max-w-xl mx-auto">
                    ...
                    <div id="lower-school" class="absolute text-white z-20 right-50 top-48 space-y-2 hidden px-6 md:right-40 md:w-1/2 lg:w-1/3 xl:w-1/4 lg:px-0">
                    ...
                    <div id="middle-school" class="absolute text-white z-20 right-50 top-48 space-y-2 hidden px-6 md:right-40 md:w-1/2 lg:w-1/3 xl:w-1/4 lg:px-0">
                    ...
                    <div id="high-school" class="absolute text-white z-20 right-50 top-48 space-y-2 hidden px-6 md:right-40 md:w-1/2 lg:w-1/3 xl:w-1/4 lg:px-0">
        ...
        <section id="faq" class="max-w-7xl mx-auto">
            <div class="flex flex-col mt-32 lg:flex-row lg:justify-center">
                <div class="flex justify-center w-full text-white text-5xl font-extralight space-y-1 lg:justify-end lg:pr-20 lg:w-1/4">
