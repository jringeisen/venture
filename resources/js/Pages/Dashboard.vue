            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 gap-3">
                    <div class="flex flex-col justify-between space-y-3">
                        <div class="bg-white h-full dark:bg-gray-800 p-6 space-y-2 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="text-gray-500 dark:text-gray-100">Total Questions</div>
                            <p class="text-4xl font-bold">{{ totalQuestions }}</p>
                        </div>

                        <div class="bg-white h-full p-6 dark:bg-gray-800 space-y-2 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="bg-white p-6 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="text-gray-500 dark:text-gray-100">Subjects</div>
