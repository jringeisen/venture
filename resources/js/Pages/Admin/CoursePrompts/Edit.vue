                    ...
                    <div v-if="prompt.days?.length" class="space-y-3">
                        <div v-for="day in prompt.days" :key="day.id" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center space-x-3">
                                <Link :href="route('admin.courses.weeks.days.edit', [course.id, prompt.id, day.id])" class="text-beach-teal hover:text-beach-teal-dark text-sm">
                                    Edit
                                </Link>
                                <button @click="deleteDay(day)" class="text-red-600 hover:text-red-900 text-sm">
                                    Delete
                                </button>
                            </div>
                        </div>
