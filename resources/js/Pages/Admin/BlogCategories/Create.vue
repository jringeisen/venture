<template>
    <AdminLayout title="Create Category">
        <div class="max-w-2xl">
            <div class="mb-6">
                <Link :href="route('admin.blog-categories.index')" class="text-sm text-beach-text-light hover:text-beach-text">
            ...
            <div class="bg-white dark:bg-primary-gray shadow-sm dark:shadow-neutral-900/50 border border-slate-100 dark:border-neutral-700 rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg font-medium text-beach-text dark:text-neutral-200 mb-6">Create New Category</h3>
