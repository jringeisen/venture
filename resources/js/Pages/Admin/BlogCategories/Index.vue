    ...
    <AdminLayout title="Blog Categories">
        <div class="space-y-6">
            <div class="sm:flex sm:items-center sm:justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-beach-text dark:text-white">Blog Categories</h2>
                    <p class="mt-1 text-sm text-beach-text-light dark:text-gray-400">Organize your blog posts with categories.</p>
                </div>
            ...
            <div class="bg-white dark:bg-neutral-800 shadow-sm border border-slate-100 dark:border-neutral-700 rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-700">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-beach-text-light dark:text-gray-300 uppercase tracking-wider">Name</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-beach-text-light dark:text-gray-300 uppercase tracking-wider">Posts</th>
                    ...
                    <tbody class="bg-white dark:bg-neutral-800 divide-y divide-gray-200 dark:divide-neutral-700">
                        <tr v-for="category in categories.data" :key="category.id">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-beach-text dark:text-white">{{ category.name }}</div>
                                <div class="text-sm text-beach-text-light dark:text-gray-400">{{ category.slug }}</div>
                            </td>
                        ...
                        <tr v-if="categories.data.length === 0">
                            <td colspan="3" class="px-6 py-4 text-center text-sm text-beach-text-light dark:text-gray-400">
                                No categories yet.
                            </td>
                        </tr>
                    </tbody>
