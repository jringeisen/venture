    ...
    <div class="bg-white">
        ...
        <header class="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md shadow-sm z-50">
            <nav class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-8">
                    <a href="#about" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">ABOUT</a>
                    <a href="#mission" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">MISSION</a>
                    <a href="#subjects" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">SUBJECTS</a>
                    <a href="#causes" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">SUPPORT</a>
                    <Link :href="route('blog-posts.index')" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">BLOG</Link>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-4">
                    <Link :href="route('auth.options')" class="text-sm font-semibold leading-6 text-beach-ocean-deep hover:text-beach-teal transition">Log in <span aria-hidden="true">&rarr;</span></Link>
                    <Link :href="route('register')" class="inline-flex items-center px-5 py-2.5 bg-beach-teal border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-beach-teal-dark focus:outline-none focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 transition ease-in-out duration-150">Get Started</Link>
                </div>
            </nav>
                    ...
                    <div class="mt-8 flow-root">
                        <div class="-my-6 divide-y divide-white/10">
                            <div class="space-y-1 py-6">
                                <a href="#about" @click="toggleMobileMenu()" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">About</a>
                                <a href="#mission" @click="toggleMobileMenu()" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">Mission</a>
                                <a href="#subjects" @click="toggleMobileMenu()" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">Subjects</a>
                                <a href="#causes" @click="toggleMobileMenu()" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">Support</a>
                                <Link :href="route('blog-posts.index')" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">Blog</Link>
                            </div>
                            <div class="py-6 space-y-1">
                                <Link :href="route('auth.options')" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-white hover:bg-beach-ocean transition">Log in</Link>
                                <Link :href="route('register')" class="-mx-3 block rounded-lg px-3 py-3 text-base font-semibold text-beach-teal-light hover:bg-beach-ocean transition">Get Started Free</Link>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="relative min-h-screen flex items-center justify-center">
            ...
            <div class="relative z-10 text-center px-6 max-w-4xl mx-auto pt-20">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                    <Link :href="route('register')" class="px-8 py-4 bg-beach-teal text-white rounded-lg font-semibold uppercase tracking-widest hover:bg-beach-teal-dark focus:outline-none focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 transition ease-in-out duration-150">Get Started Free</Link>
                    <a href="#mission" class="px-8 py-4 border-2 border-white text-white rounded-lg font-semibold uppercase tracking-widest hover:bg-white/10 transition ease-in-out duration-150">Our Mission</a>
                </div>
            </div>
        ...
        <section class="bg-beach-ocean-deep py-10">
            <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white px-6">
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="mt-1 text-white/80 text-sm tracking-wider uppercase">Free for Every Learner</p>
                </div>
        ...
        <section id="about" class="scroll-mt-20 py-24 bg-white">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-slate-50 rounded-2xl p-8 text-center hover:shadow-lg transition" data-aos="fade-up">
                    ...
                    <div class="bg-slate-50 rounded-2xl p-8 text-center hover:shadow-lg transition" data-aos="fade-up" data-aos-delay="100">
                        <div class="w-16 h-16 mx-auto bg-beach-teal/10 rounded-xl flex items-center justify-center mb-6">
                            <svg class="w-8 h-8 text-beach-teal" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="bg-slate-50 rounded-2xl p-8 text-center hover:shadow-lg transition" data-aos="fade-up" data-aos-delay="200">
                        <div class="w-16 h-16 mx-auto bg-beach-teal/10 rounded-xl flex items-center justify-center mb-6">
                            <svg class="w-8 h-8 text-beach-teal" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <section id="mission" class="scroll-mt-20 relative">
            ...
            <div class="relative py-24">
                <div class="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-16 items-start">
                    ...
                    <div id="donate" class="bg-white rounded-2xl p-8 w-full max-w-md shadow-2xl">
                        <h3 class="text-2xl font-semibold text-beach-text">Make a Donation</h3>
                        <p class="mt-2 text-beach-text-light">Every penny goes directly towards providing free education to children across the globe.</p>
                        <div class="mt-6">
                            <div class="flex rounded-lg shadow-sm">
                                <span class="inline-flex items-center bg-beach-teal rounded-l-lg border border-r-0 border-gray-300 px-4">
                                    <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                </span>
                                <input type="number" step="any" v-model="form.donationAmount" class="block w-full min-w-0 flex-1 rounded-none rounded-r-lg border-0 py-3 text-gray-900 font-bold ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-beach-teal sm:text-xl sm:leading-6" placeholder="100.00">
                            </div>
                            <div class="mt-4 grid grid-cols-3 gap-2">
                                <button v-for="amount in [10, 25, 50, 100, 250]" :key="amount" @click.prevent="form.donationAmount = amount" class="px-4 py-2.5 font-semibold rounded-lg transition" :class="form.donationAmount === amount ? 'bg-beach-teal text-white' : 'bg-slate-50 hover:bg-white text-beach-text ring-1 ring-beach-teal/20'">
                                    ${{ amount }}
                                </button>
                                <button @click.prevent="form.donationAmount = 0" class="px-4 py-2.5 font-semibold rounded-lg text-sm transition" :class="![10, 25, 50, 100, 250].includes(form.donationAmount) ? 'bg-beach-teal text-white' : 'bg-slate-50 hover:bg-white text-beach-text ring-1 ring-beach-teal/20'">
                                    Custom
                                </button>
                            </div>
                            <a :href="paymentLink" class="block mt-6">
                                <button class="w-full bg-beach-teal text-white font-bold rounded-lg py-3.5 text-center uppercase tracking-widest hover:bg-beach-teal-dark transition">Donate Now</button>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    <div v-for="subject in subjects" :key="subject.name" class="bg-white rounded-xl p-5 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-200 group cursor-default" data-aos="fade-up">
                        <img :src="subject.icon" :alt="subject.name" class="w-10 h-10 mx-auto mb-3 group-hover:scale-110 transition" loading="lazy" />
                        <p class="text-sm font-medium text-beach-text">{{ subject.name }}</p>
                    </div>
                </div>
                <div class="text-center mt-12">
                    <Link :href="route('register')" class="inline-flex items-center px-8 py-4 bg-beach-teal text-white rounded-lg font-semibold uppercase tracking-widest hover:bg-beach-teal-dark transition">Start Exploring</Link>
                </div>
            </div>
        </section>

        <!-- Crowdfunding -->
        <section id="causes" class="scroll-mt-20 py-24 bg-white">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-16 max-w-3xl mx-auto">
                    <p class="text-beach-teal font-semibold tracking-wider uppercase text-sm">Support Our Work</p>
                    <h2 class="mt-3 text-3xl md:text-5xl font-light text-beach-ocean-deep tracking-wide">Crowdfunding Campaigns</h2>
                    <p class="mt-6 text-lg text-beach-text-light leading-relaxed">
                        Join our campaign to support a small, passionate team working voluntarily to transform educational experiences worldwide. Your contributions allow us to keep building our vision.
                    </p>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div v-for="(cause, index) in causes" :key="index" class="bg-white rounded-2xl overflow-hidden border border-slate-100 hover:shadow-lg transition-all duration-300" data-aos="fade-up">
                        <img :src="cause.image" :alt="cause.text" class="w-full h-52 object-cover" loading="lazy" />
                        <div class="p-6">
                            <h3 class="text-lg font-bold text-beach-text">{{ cause.text }}</h3>
                            <p class="mt-2 text-sm text-beach-text-light leading-relaxed">{{ cause.description }}</p>
                            <a :href="cause.paymentLink" class="block mt-5">
                                <button class="w-full bg-beach-teal text-white py-3 rounded-lg font-semibold tracking-wider hover:bg-beach-teal-dark transition">Donate Now</button>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <section class="relative py-32">
            ...
            <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
                ...
                <Link :href="route('register')" class="mt-10 inline-flex items-center px-10 py-4 bg-beach-teal text-white rounded-lg font-semibold uppercase tracking-widest hover:bg-beach-teal-dark focus:outline-none focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 transition ease-in-out duration-150">Join Venture &mdash; It's Free</Link>
            </div>
        </section>
                    ...
                    <div class="flex gap-16">
                        <div>
                            ...
                            <ul class="space-y-3 text-white/60">
                                <li><Link :href="route('register')" class="hover:text-white transition">Get Started</Link></li>
                                <li><a href="#subjects" class="hover:text-white transition">Subjects</a></li>
                                <li><Link :href="route('blog-posts.index')" class="hover:text-white transition">Blog</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h4 class="font-semibold text-beach-teal-light mb-4 text-sm uppercase tracking-wider">Support</h4>
                            <ul class="space-y-3 text-white/60">
                                <li><a href="#causes" class="hover:text-white transition">Donate</a></li>
                                <li><a href="#mission" class="hover:text-white transition">Our Mission</a></li>
                                <li><Link :href="route('auth.options')" class="hover:text-white transition">Log In</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex gap-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-5 w-5 text-white/60 hover:text-white transition cursor-pointer">
