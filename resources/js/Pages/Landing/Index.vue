<template>
    ...
    <div class="relative bg-primary-dark-gray">
        <header class="sticky top-0 bg-primary-dark-gray z-20">
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="flex lg:hidden">
                    <button @click.prevent="toggleMobileMenu" type="button"
            ...
            <section>
                ...
                <div id="sectionTwoQuestionCards" class="mt-10 grid grid-cols-2 gap-1 px-4 md:grid-cols-4 lg:grid-cols-5">
                    <div @click.prevent="imageSix = !imageSix"
                        ...
                        <div
                            v-if="imageSix"
                            class="absolute bg-primary-gray text-white p-4 w-full h-full left-0 top-0 animate-fade-in-right overflow-y-auto md:left-full md:w-72">
                    ...
                    <div @click.prevent="imageEight = !imageEight"
                        ...
                        <div
                            v-if="imageEight"
                            class="absolute bg-primary-gray text-white p-4 w-full h-full right-0 top-0 animate-fade-in-right overflow-y-auto md:right-full md:w-72">
        ...
        <div v-if="shouldShowBackground()" @click.prevent="handleClickOutside($event)" id="opaque-background" class="absolute inset-0 bg-black opacity-75 z-20"></div>
    </div>
</template>
