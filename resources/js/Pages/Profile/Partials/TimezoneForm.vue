    ...
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            <div>
                ...
                <select id="timezone" v-model="form.timezone" class="border-gray-300 focus:border-beach-teal focus:ring-beach-teal rounded-md shadow-sm dark:focus:border-neutral-900 dark:focus:ring-neutral-900 dark:border-neutral-900 dark:bg-primary-gray dark:text-neutral-400 dark:placeholder:text-neutral-400">
