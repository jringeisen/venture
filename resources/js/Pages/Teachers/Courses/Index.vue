<template>
    ...
    <div class="py-12">
        <div v-if="courses.total < 4" class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="500" height="500"
                    ...
                    <path
                        ...
                        transform="translate(-11.09 -87.76)" fill="#ffcc00" opacity="0.1"/>
                    <path
                    ...
                    <g opacity="0.2">
                        ...
                        <path
                            ...
                            transform="translate(-11.09 -87.76)" fill="#ffcc00"/>
                        <path
            ...
            <div class="mt-3 text-3xl text-center">
                Coming Soon
            </div>
        </div>
        <div v-else class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        <form class="mt-4">
                            <div class="border-t border-gray-200 pb-4 pt-4">
                                <fieldset>
                                    <legend class="w-full px-2">
                                        <span class="text-sm font-medium text-gray-900">Courses</span>
                                    </legend>
                                    <div class="px-4 pb-2 pt-4" id="filter-section-0">
                                        <div class="space-y-6">
                                            <div class="flex items-center" v-for="(category, index) in categories">
                                                <input :id="`color-${index}-mobile`" name="mobile-category[]"
                                                       :value="category" type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-primary-yellow focus:ring-primary-yello"
                                                       v-model="categoryFilters"
                                                >
                                                <label :for="`color-${index}-mobile`"
                                                       class="ml-3 text-sm text-gray-500">{{ category }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="border-t border-gray-200 pb-4 pt-4">
                                <fieldset>
                                    <legend class="w-full px-2">
                                        <span class="text-sm font-medium text-gray-900">Course Length</span>
                                    </legend>
                                    <div class="px-4 pb-2 pt-4" id="filter-section-1">
                                        <div class="space-y-6">
                                            <div class="flex items-center" v-for="(length, index) in lengths">
                                                <input :id="`length-${index}-mobile`" name="mobile-length[]"
                                                       :value="length"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-primary-yellow focus:ring-primary-yellow"
                                                       v-model="lengthFilters">
                                                <label :for="`length-${index}-mobile`"
                                                       class="ml-3 text-sm text-gray-500">{{ length }} weeks</label>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="border-t border-gray-200 pb-4 pt-4">
                                <fieldset>
                                    ...
                                    <div class="px-4 pb-2 pt-4" id="filter-section-2">
                                        <div class="space-y-6">
                                            <div class="flex items-center" v-for="(level, index) in levels">
                                                <input :id="`levels-${index}-mobile`" name="mobile-level[]"
                                                       :value="level" type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-primary-yellow focus:ring-primary-yellow"
                                                       v-model="levelFilters">
                                                <label :for="`levels-${index}-mobile`"
                                                       class="ml-3 text-sm text-gray-500">{{ level }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
            ...
            <div class="mx-auto max-w-2xl lg:max-w-7xl">
                <div class="border-b border-gray-200 pb-10">
                    ...
                    <p class="mt-4 text-base text-gray-500">Explore a world of learning with our diverse range of
                        courses. Unlock new knowledge and skills at your own pace. Start your journey of discovery
                        today.</p>
                ...
                <div class="pt-12 lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
                    <aside>
                        ...
                        <button type="button" class="inline-flex items-center lg:hidden" @click="toggleMobileMenu">
                            <span class="text-sm font-medium text-gray-700">Filters</span>
                            <svg class="ml-1 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20"
                        ...
                        <div class="hidden lg:block">
                            <form class="space-y-10 divide-y divide-gray-200">
                                <div>
                                    <fieldset>
                                        <legend class="block text-sm font-medium text-gray-900">Courses</legend>
                                ...
                                <div class="pt-10">
                                    <fieldset>
                                        <legend class="block text-sm font-medium text-gray-900">Course Length</legend>
                                        <div class="space-y-3 pt-6">
                                            <div class="flex items-center" v-for="(length, index) in lengths"
                                                 :key="length">
                                                <input
                                                ...
                                                <label :for="`'length'-${index}`"
                                                       class="ml-3 text-sm text-gray-600">{{ length }} weeks</label>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="pt-10">
                                    <fieldset>
                                        <legend class="block text-sm font-medium text-gray-900">Grades</legend>
                                        <div class="space-y-3 pt-6">
                                            <div class="flex items-center" v-for="(level, index) in levels"
                                                 :key="level">
                                                <input
                                                ...
                                                <label :for="`'level'-${index}`"
                                                       class="ml-3 text-sm text-gray-600">{{ level }}</label>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                <div class="pt-10 text-primary-yellow">
                                    <button type="button" class="inline-flex items-center gap-x-1.5"
                                            @click="resetFilters">
                    ...
                    <div v-if="loading" class="mt-6 col-span-2 lg:mt-0 xl:col-span-3 mx-auto">
                        <ArrowPathIcon class="text-primary-yellow animate-spin h-[12rem] w-[12rem]"/>
                    </div>
                    ...
                    <div v-else class="mt-6 lg:col-span-2 lg:mt-0 xl:col-span-3">
                        ...
                        <div v-if="courses.total > courses.per_page" class="mt-3">
                            <nav class="flex items-center justify-between px-4 py-3 sm:px-8 dark:bg-neutral-600"
                                ...
                                <div class="flex flex-1 justify-between sm:justify-end">
                                    <button
                                        ...
                                        :class="!courses.prev_page_url ? 'bg-gray-200 cursor-not-allowed' : 'bg-white'"
                                        class="relative inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:outline-offset-0 dark:bg-primary-yellow dark:ring-0 dark:border-none"
                                        @click="previousPage"
                                    >
                                        Previous
                                    </button>
                                    ...
                                    <button
                                        ...
                                        :class="!courses.next_page_url ? 'bg-gray-200 cursor-not-allowed' : 'bg-white'"
                                        class="relative ml-3 inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:outline-offset-0 dark:bg-primary-yellow dark:ring-0 dark:border-none"
                                        @click="nextPage"
                                    >
                                        Next
                                    </button>
...
let lengthFilters = ref([]);

let levelFilters = ref([]);

let search = ref('');

let searchBy = ref('Course');
