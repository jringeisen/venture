        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white shadow-sm border border-slate-100 p-8 rounded-lg dark:bg-primary-gray dark:border-neutral-700">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-base font-semibold leading-6 text-beach-text dark:text-neutral-400">Current Plan</h1>
                        <div class="mt-2 flex items-center gap-3">
                            <span class="text-2xl font-bold text-beach-text dark:text-neutral-200">{{ subscription.plan_label }}</span>
                            <span
                                class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium"
                                :class="subscription.is_active ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : subscription.on_grace_period ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300' : 'bg-gray-100 text-gray-700 dark:bg-neutral-600 dark:text-neutral-300'"
                            >
            ...
            <!-- Usage Meters -->
            <div class="bg-white shadow-sm border border-slate-100 p-8 rounded-lg dark:bg-primary-gray dark:border-neutral-700">
                <h2 class="text-base font-semibold leading-6 text-beach-text dark:text-neutral-400">Usage</h2>
                <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-3">
                    ...
                    <!-- Students -->
                    <div class="rounded-lg border border-gray-200 p-5 dark:border-neutral-600">
                        <dt class="text-xs text-beach-text-light dark:text-neutral-500">Students</dt>
                        <dd class="mt-1 text-lg font-semibold text-beach-text dark:text-neutral-300">
                        ...
                        <div class="mt-2 w-full bg-gray-200 rounded-full h-2 dark:bg-neutral-600">
                    ...
                    <!-- Compliance Reports -->
                    <div class="rounded-lg border border-gray-200 p-5 dark:border-neutral-600">
                        <dt class="text-xs text-beach-text-light dark:text-neutral-500">Compliance Reports This Month</dt>
                        <dd class="mt-1 text-lg font-semibold text-beach-text dark:text-neutral-300">
                        ...
                        <div v-if="!isUnlimited(subscription.limits.compliance_reports_per_month) && subscription.limits.compliance_reports_per_month > 0" class="mt-2 w-full bg-gray-200 rounded-full h-2 dark:bg-neutral-600">
