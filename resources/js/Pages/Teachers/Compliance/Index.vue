    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white shadow-sm border border-slate-100 p-8 rounded-lg dark:bg-primary-gray dark:border-neutral-700 dark:shadow-neutral-900/50">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-beach-text dark:text-neutral-200">Student Overview</h1>
                ...
                <div class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div v-for="student in students" :key="student.id" class="rounded-lg border border-gray-200 p-6 dark:border-neutral-700">
                        <div class="flex items-center justify-between">
                            <h3 class="text-sm font-semibold text-beach-text dark:text-neutral-200">{{ student.name }}</h3>
                        ...
                        <dl class="mt-4 grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <dd class="text-lg font-semibold text-beach-text dark:text-neutral-200">{{ student.instruction_days }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs text-beach-text-light dark:text-neutral-400">Instruction Hours</dt>
                                <dd class="text-lg font-semibold text-beach-text dark:text-neutral-200">{{ student.instruction_hours }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs text-beach-text-light dark:text-neutral-400">Active Courses</dt>
                                <dd class="text-lg font-semibold text-beach-text dark:text-neutral-200">{{ student.courses_active }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs text-beach-text-light dark:text-neutral-400">Completed</dt>
                                <dd class="text-lg font-semibold text-beach-text dark:text-neutral-200">{{ student.courses_completed }}</dd>
                            </div>
                        </dl>
                        <div class="mt-4">
            ...
            <div class="bg-white shadow-sm border border-slate-100 p-8 rounded-lg dark:bg-primary-gray dark:border-neutral-700 dark:shadow-neutral-900/50">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-beach-text dark:text-neutral-200">Compliance Reports</h1>
                        <p class="mt-2 text-sm text-beach-text-light dark:text-neutral-400">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black/5 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300 dark:divide-neutral-700">
                                    <thead class="bg-gray-50 dark:bg-neutral-800">
                                        <tr>
                                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-beach-text sm:pl-6 dark:text-neutral-200">Title</th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-beach-text dark:text-neutral-200">Student</th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-beach-text dark:text-neutral-200">Period</th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-beach-text dark:text-neutral-200">Status</th>
                                            <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
                                                <span class="sr-only">Actions</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-200 bg-white dark:bg-primary-gray dark:divide-neutral-700">
                                        <tr v-for="report in reports.data" :key="report.id">
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-beach-text sm:pl-6 dark:text-neutral-200">
                                                {{ report.title }}
                                            </td>
                                ...
                                <div v-if="reports.total > reports.per_page" class="border-t dark:border-neutral-700">
                                    <Pagination :data="reports" class="dark:bg-primary-gray"/>
                                </div>
                            </div>
                        </div>
                    </div>
