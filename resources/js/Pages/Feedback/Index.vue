            ...
            <div class="bg-white shadow-sm border border-slate-100 p-8 rounded-lg dark:bg-primary-gray dark:border-neutral-700 dark:shadow-neutral-900/50">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-beach-text dark:text-neutral-200">Feedback</h1>
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <div class="overflow-hidden shadow ring-1 ring-black/5 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300 dark:divide-neutral-700">
                                    <thead class="bg-gray-50 dark:bg-neutral-800">
                                        <tr>
                                            <th
                                                scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-beach-text sm:pl-6 dark:text-neutral-200"
                                            >
                                                Title
                                            </th>
                                            <th
                                                scope="col"
                                                class="px-3 py-3.5 text-left text-sm font-semibold text-beach-text dark:text-neutral-200"
                                            >
                                                Status
                                            </th>
                                            <th
                                ...
                                <div v-if="feedback.total > feedback.per_page" class="border-t">
                                    <Pagination :data="feedback" class="dark:bg-primary-gray" />
                                </div>
                            </div>
                        </div>
                    </div>
