<template>
    ...
    <div class="bg-primary-dark-gray">
        <div class="max-w-4xl mx-auto prose prose-neutral py-20 text-neutral-400">
            ...
            <p>
                At Venture, we strive to provide the best possible products and services to our customers. However, due
                to the finality of our sales transactions, no refunds will be issued under any circumstances. This
                policy is in place to ensure a smooth and efficient transaction process for both our company and our
                valued customers.
            </p>
            ...
            <p>
                By proceeding with a purchase on Venture's website, you acknowledge and agree to this all sales are
            ...
            <p>
                ...
                information to provide and improve our personalized learning experience. By using Venture, you consent
            ...
            <p>
                ...
                intended for educational purposes only and should not be considered as professional advice or a
                substitute for expert guidance. You acknowledge that you are solely responsible for your actions and
