    ...
    <div>
        <div v-if="loading || processing" role="status" class="max-w-sm">
            ...
            <div class="flex items-center mb-2">
                ...
                <span class="text-sm dark:text-neutral-500">Generating related questions...</span>
            </div>
            <!-- Skeleton Loaders -->
            ...
            <span class="sr-only">Loading related questions...</span>
        </div>
        <div v-else-if="error" class="text-red-500 flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <span class="text-sm">Failed to generate questions -
            ...
            <div class="whitespace-pre-wrap mt-14">
                <ul>
                    <li
                        ...
                        :key="index"
                        class="mb-2.5 cursor-pointer text-beach-ocean underline hover:text-beach-ocean-deep transition-colors"
                        :class="{'text-beach-ocean-deep font-bold': item.selected}"
