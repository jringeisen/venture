<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-full mx-auto px-10 pb-20">
            <form @submit.prevent="submit" class="flex items-center mt-12 relative">
                <TextInput
            ...
            <div v-if="result && result.flagged" class="mt-6 bg-red-200 p-4 rounded-lg text-red-600 whitespace-pre-wrap">{{ result.message }}</div>


            <div v-if="!form.processing && result && result.flagged !== true">
