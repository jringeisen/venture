        ...
        <div class="flex flex-col sm:items-center sm:justify-between sm:flex-row">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select id="timeframe" class="mt-2 block w-full rounded-full border-0 py-2 px-14 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-primary-yellow dark:bg-neutral-800 dark:text-neutral-400 dark:ring-0 sm:text-sm sm:leading-6">
