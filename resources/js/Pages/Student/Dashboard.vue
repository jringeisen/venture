    ...
    <div class="max-w-7xl mx-auto space-y-8 sm:px-6 lg:px-8">
        ...
        <div>
            ...
            <div v-if="enrolledCourses && enrolledCourses.length > 0" class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                >
                    <div class="h-40 overflow-hidden">
                        ...
                        <div
                            v-else
                            class="w-full h-40 bg-gradient-to-br from-beach-teal to-beach-teal-dark flex items-center justify-center"
                        >
                    ...
                    <div class="p-2 space-y-2">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-neutral-700">
                            <div
                                class="bg-beach-teal h-2.5 rounded-full transition-all"
            ...
            <div v-else class="bg-white border rounded-lg p-8 text-center dark:border-none dark:bg-neutral-800">
                ...
                <Link href="/student/courses" class="inline-flex items-center px-4 py-2 bg-beach-teal text-white font-semibold rounded-lg hover:bg-beach-teal-dark transition-colors">
                    Browse Courses
                </Link>
            </div>
        </div>
...
const handleTimeframeChange = () => {
    form.get(route('student.dashboard', { timeframe: form.timeframe }))
}
