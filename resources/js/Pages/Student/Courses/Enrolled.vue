        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-beach-text dark:text-white mb-2">
                            My Courses
                        </h1>
                    ...
                    <Link
                        ...
                        class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-lg text-beach-text-light dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-beach-text dark:text-white">{{ stats.totalEnrolled }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-beach-text dark:text-white">{{ stats.totalCompleted }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-beach-text dark:text-white">{{ activeCourses.length }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-beach-text dark:text-white">{{ Math.round(stats.averageProgress || 0) }}%</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="activeCourses.length > 0" class="mb-8">
                <h2 class="text-xl font-semibold text-beach-text dark:text-white mb-4">Continue Learning</h2>
                    ...
                    >
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-beach-text dark:text-white mb-1">
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between text-sm mb-1">
                                    ...
                                    <span class="font-medium text-beach-text dark:text-white">
                            ...
                            <!-- Course Info -->
                            <div class="flex items-center justify-between text-sm text-beach-text-light dark:text-gray-400 mb-4">
            ...
            <div v-if="completedCourses.length > 0" class="mb-8">
                <h2 class="text-xl font-semibold text-beach-text dark:text-white mb-4">Completed Courses</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div
