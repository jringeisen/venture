        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-beach-text dark:text-neutral-200 mb-2">
                            My Courses
                        </h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div class="bg-white dark:bg-primary-gray rounded-lg p-4 border border-gray-200 dark:border-neutral-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-neutral-400">Total Enrolled</p>
                            <p class="text-2xl font-bold text-beach-text dark:text-neutral-200">{{ stats.totalEnrolled }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-primary-gray rounded-lg p-4 border border-gray-200 dark:border-neutral-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-neutral-400">Completed</p>
                            <p class="text-2xl font-bold text-beach-text dark:text-neutral-200">{{ stats.totalCompleted }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-primary-gray rounded-lg p-4 border border-gray-200 dark:border-neutral-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-neutral-400">In Progress</p>
                            <p class="text-2xl font-bold text-beach-text dark:text-neutral-200">{{ activeCourses.length }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white dark:bg-primary-gray rounded-lg p-4 border border-gray-200 dark:border-neutral-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600 dark:text-neutral-400">Avg Progress</p>
                            <p class="text-2xl font-bold text-beach-text dark:text-neutral-200">{{ Math.round(stats.averageProgress || 0) }}%</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="activeCourses.length > 0" class="mb-8">
                <h2 class="text-xl font-semibold text-beach-text dark:text-neutral-200 mb-4">Continue Learning</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div
                        v-for="enrollment in activeCourses"
                        :key="enrollment.id"
                        class="bg-white dark:bg-primary-gray rounded-xl shadow-sm dark:shadow-neutral-900/50 border border-gray-200 dark:border-neutral-700 overflow-hidden hover:shadow-md transition-shadow"
                    >
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-beach-text dark:text-neutral-200 mb-1">
                                        {{ enrollment.course.title }}
                                    </h3>
                                    <p class="text-sm text-gray-600 dark:text-neutral-400 line-clamp-2">
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between text-sm mb-1">
                                    <span class="text-gray-600 dark:text-neutral-400">Progress</span>
                                    <span class="font-medium text-beach-text dark:text-neutral-200">
                            ...
                            <!-- Course Info -->
                            <div class="flex items-center justify-between text-sm text-beach-text-light dark:text-neutral-400 mb-4">
                            ...
                            <Link
                                ...
                                class="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-beach-teal hover:bg-beach-teal-dark transition-colors"
                            >
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-if="completedCourses.length > 0" class="mb-8">
                <h2 class="text-xl font-semibold text-beach-text dark:text-neutral-200 mb-4">Completed Courses</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div
                        v-for="enrollment in completedCourses"
                        :key="enrollment.id"
                        class="bg-white dark:bg-primary-gray rounded-xl shadow-sm dark:shadow-neutral-900/50 border border-gray-200 dark:border-neutral-700 overflow-hidden"
                    >
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
