    ...
    <div class="min-h-screen bg-gray-100 dark:bg-primary-dark-gray py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div ref="certificateRef" class="bg-white rounded-lg shadow-2xl overflow-hidden print:shadow-none">
                <!-- Certificate Border -->
                <div class="p-2 bg-gradient-to-r from-beach-teal via-beach-teal-dark to-beach-teal">
                    <div class="bg-white p-8 sm:p-12">
                        <!-- Header -->
                        <div class="text-center mb-8">
                            <div class="flex justify-center mb-4">
                                <div class="w-16 h-16 bg-gradient-to-br from-beach-teal to-beach-teal-dark rounded-full flex items-center justify-center">
                                    <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"/>
                                    </svg>
                                </div>
                            </div>
                            <h1 class="text-3xl sm:text-4xl font-serif font-bold text-beach-text mb-2">Certificate of Completion</h1>
                            <p class="text-beach-text-light text-sm uppercase tracking-widest">This certifies that</p>
                        </div>

                        <!-- Recipient Name -->
                        <div class="text-center mb-8">
                            <h2 class="text-4xl sm:text-5xl font-serif font-bold text-beach-teal mb-2">{{ user.name }}</h2>
                            <div class="w-64 h-0.5 bg-gradient-to-r from-transparent via-gray-300 to-transparent mx-auto"></div>
                        </div>

                        <!-- Course Details -->
                        <div class="text-center mb-8">
                            <p class="text-beach-text-light text-lg mb-2">has successfully completed the course</p>
                            <h3 class="text-2xl sm:text-3xl font-bold text-beach-text mb-4">{{ course.title }}</h3>
                            <p class="text-beach-text-light max-w-lg mx-auto">{{ course.description }}</p>
                        </div>

                        <!-- Achievement Stats -->
                        <div class="grid grid-cols-3 gap-4 max-w-md mx-auto mb-8">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-beach-text">{{ course.length_in_weeks }}</div>
                                <div class="text-xs text-beach-text-light uppercase tracking-wide">Weeks</div>
                            </div>
                            <div class="text-center border-x border-gray-200">
                                <div class="text-2xl font-bold text-beach-text">{{ averageScore }}%</div>
                                <div class="text-xs text-beach-text-light uppercase tracking-wide">Avg. Score</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-beach-text">{{ timeSpent }}</div>
                                <div class="text-xs text-beach-text-light uppercase tracking-wide">Time Spent</div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between items-end pt-8 border-t border-gray-200">
                            <div class="text-left">
                                <p class="text-sm text-beach-text-light mb-1">Date of Completion</p>
                                <p class="text-lg font-semibold text-beach-text">{{ completedAt }}</p>
                            </div>
                            <div class="text-center">
                                <div class="w-40 border-b-2 border-gray-300 mb-2"></div>
                                <p class="text-sm text-beach-text-light">Authorized Signature</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm text-beach-text-light mb-1">Certificate ID</p>
                                <p class="text-sm font-mono text-beach-text-light">{{ certificateId }}</p>
                            </div>
                        </div>

                        <!-- Decorative Elements -->
                        <div class="absolute top-4 left-4 w-24 h-24 opacity-5">
                            <svg viewBox="0 0 100 100" fill="currentColor" class="text-beach-teal">
