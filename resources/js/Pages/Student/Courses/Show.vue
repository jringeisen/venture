    ...
    <div class="bg-gray-200 h-screen">
        <div class="w-full bg-primary-gray px-10 py-8">
            <div class="text-xs space-x-1 text-white">
                ...
                <Link as="a" :href="route('student.courses.index')" class="text-gray-400">Courses</Link>
                <span class="text-gray-400">></span>
                <span class="font-bold">{{ course.title }}</span>
            </div>

            <h2 class="text-2xl font-semibold py-3 text-white">{{ course.title }}</h2>
            <p class="text-xs w-full text-white leading-4 md:w-2/3 lg:w-1/2">{{ course.description }}</p>

            <div class="flex text-white text-xs mt-6 items-center space-x-1">
                <p>40 Minutes to Complete</p>
                <p>&#x2022</p>
                <p>36 Modules in Course</p>
                <p>&#x2022</p>
        ...
        <div>
            <div class="flex relative md:space-x-3">
                ...
                <div class="absolute shadow w-60 right-10 -top-40 rounded-lg hidden p-3 bg-white divide-y-2 space-y-3 md:block">
                    ...
                    <div class="py-4">
                        <p class="text-black text-sm">Course Description</p>
                        <p class="text-xs text-gray-800 py-2">
                            Embark on a celestial journey with our beinnger's astronomy course, perfect for middle schoolers curious about the stars or anyone ready to dive deeper into
                            the mysteries of the universe. This course is designed to be engaging and interactive, with hands-on activities and experiments that will help you learn about the solar system, stars, and galaxies.
                        </p>

                        <p class="text-black text-sm">Course Details</p>
