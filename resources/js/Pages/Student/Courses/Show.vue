                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <div
                                v-else
                                class="w-full h-full bg-gradient-to-br from-beach-teal to-beach-teal-dark"
                            ></div>
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <div class="absolute bottom-6 left-6 right-6">
                                <div v-if="course.subject_category || course.difficulty_level" class="flex items-center space-x-3 mb-3">
                                    <span v-if="course.subject_category" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-beach-teal text-white">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6 sticky top-6">
                        <div v-if="isEnrolled" class="space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <button
                                    ...
                                    class="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-beach-teal-dark to-beach-teal hover:from-teal-800 hover:to-beach-teal-dark focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 transition-all"
                                >
                                ...
                                <button
                                    ...
                                    class="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-beach-teal hover:bg-beach-teal-dark focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 transition-colors"
                                >
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div v-else class="text-center space-y-4">
                            ...
                            <button
                                ...
                                :disabled="enrolling"
                                class="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-lg text-white bg-beach-teal hover:bg-beach-teal-dark focus:ring-2 focus:ring-beach-teal focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex space-x-3">
                                        ...
                                        <button
                                            ...
                                            :disabled="enrolling"
                                            class="px-4 py-2 text-sm font-medium text-white bg-beach-teal border border-transparent rounded-lg hover:bg-beach-teal-dark transition-colors"
                                        >
                                            Enroll Now
                                        </button>
                                    </div>
