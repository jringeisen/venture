                    ...
                    <div class="flex justify-end items-center">
                        <div>
                            ...
                            <input
                                ...
                                @change="router.visit(route('student.topic.show', topic) + '?date=' + filterByDate)"
                                class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-neutral-700 dark:ring-0 dark:text-neutral-400 dark:focus:ring-neutral-900 dark:focus:border-neutral-900"
                            >
                        </div>
                    </div>
                    <div class="mt-8 flow-root">
                        <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                <ul v-if="questions.length > 0" role="list" class="-mb-8">
