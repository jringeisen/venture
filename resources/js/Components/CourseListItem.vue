                    ...
                    <div class="flex items-start justify-between mb-2">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-3 mt-1">
                                ...
                                <span v-if="recommended" class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200">
